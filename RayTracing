...
aCord = np.array([[0,500,0.5]]) #(x, y, z)
bCord = np.array([[500,0,0.5]]) #(x, y, z)
cCord = np.array([[250,250,0.5]]) #(x, y, z)

# Scene objects: spheres (position, radius, color, material properties)
scene = [
    {'position': np.array([applyMatrix(aCord,tmx)[0][0],applyMatrix(aCord,tmx)[0][1],applyMatrix(aCord,tmx)[0][2]]), 'radius': .25, 'color': np.array([1., 0., 0.]), 'reflection': 0.5},
    {'position': np.array([applyMatrix(bCord,tmx)[0][0],applyMatrix(bCord,tmx)[0][1],applyMatrix(bCord,tmx)[0][2]]), 'radius': 0.25, 'color': np.array([0., 1., 0.]), 'reflection': 0.8},
    {'position': np.array([applyMatrix(cCord,tmx)[0][0],applyMatrix(cCord,tmx)[0][1],applyMatrix(cCord,tmx)[0][2]]), 'radius': 0.25, 'color': np.array([0., 0., 1.]), 'reflection': 0.1},
    {'position': np.array([0., -10, 0.]), 'radius': 200., 'color': np.array([0.8, 0.8, 0.8]), 'reflection': 0.1} # Ground
]
